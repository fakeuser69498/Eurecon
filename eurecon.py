...
@click.option('--relative_rmsd', '-rr', help = 'Calculating relative RMSD values based on maximum distance (0) from the center of the object or maximum bound values (1)', required = False)
@click.option('--relative_rmsd_ratio', '-rrr', help = 'Proportional coefficient for the resulting realtive RMSD values', required = False)
